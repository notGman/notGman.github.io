...
ham.addEventListener('click',function(){
  ...
  homeEl.toggle.style.display= "none";
  aboutEl.toggle.style.display = "none";
  eduEl.toggle.style.display = "none";
  portEl.toggle.style.display = "none";
  contactEl.toggle.style.display = "none";
});
